export const portfolioItems = [
  {
    ...
    imgSrc: "/assets/newphotos/Jersey/26129a16e1a95800e591fa19375d20da.png",
    imgAlt: "Jersey Design",
    title: "E-sport Jersey",
    descr: "Minimalistic Black & White Design",
    categories: ["jerseys"],
    description:
      "A minimalistic e-sport jersey design with black and white aesthetics.",
  },
  {
    id: 2,
    href: "portfolio-single",
    imgSrc: "/assets/newphotos/Recent collabs/Diaspora/Diaspora.png",
    imgAlt: "Diaspora Kids Collaboration",
    title: "Diaspora Kids",
    descr: "Recent Collaboration",
    categories: ["collaborations"],
    description:
      "A successful collaboration with Diaspora Kids showcasing our design capabilities.",
  },
  {
    id: 3,
    href: "portfolio-single",
    imgSrc: "/assets/newphotos/Recent collabs/Snabba/Tailor-snabba.png",
    imgAlt: "Snabba Collaboration",
    title: "Snabba",
    descr: "Recent Collaboration",
    categories: ["collaborations"],
    description:
      "Our latest collaboration with Snabba featuring unique designs.",
  },
  {
    id: 4,
    href: "portfolio-single",
    imgSrc: "/assets/newphotos/Jackets/Screenshot 2025-02-20 at 09.54.18.png",
    imgAlt: "Minimalistic Jacket",
    title: "Team Sport Jacket",
    descr: "Oversized Boxy Design",
    categories: ["jackets"],
    description:
      "A minimalistic inspired jacket with an oversized, boxy look perfect for team sports.",
  },
  {
    id: 5,
    href: "portfolio-single",
    ...
    imgAlt: "Premium Hoodie",
    title: "500 GSM Hoodie",
    descr: "Oversized Box Fit",
    categories: ["hoodies"],
    description:
      "Premium 500 GSM hoodie featuring an oversized box fit design.",
  },
  {
    id: 6,
    href: "portfolio-single",
    ...
    imgAlt: "Heavyweight T-shirt",
    title: "300+ GSM T-shirt",
    descr: "Heavyweight Oversized Design",
    categories: ["t-shirts"],
    description: "Premium heavyweight oversized t-shirt with 300+ GSM quality.",
  },
  {
    id: 7,
    href: "portfolio-single",
    imgSrc: "/assets/newphotos/Totebag/Screenshot 2025-02-20 at 10.42.29.png",
    imgAlt: "Designer Tote Bag",
    title: "Premium Tote",
    descr: "Sustainable Design",
    categories: ["accessories"],
    description: "Sustainably crafted premium tote bag with modern aesthetics.",
  },
  {
    id: 8,
    href: "portfolio-single",
    ...
    title: "Accessories",
    descr: "Premium Collection",
    categories: ["accessories"],
    description: "Our premium collection of carefully crafted accessories.",
  },
];
...
export const portfolios4 = [
  {
    ...
    number: "70%",
    description: "growth with Tailor Studio",
  },
  {
    id: 26,
    ...
    number: "3x",
    description: "sales increased with Tailor Studio",
  },
  {
    id: 27,
    ...
    number: "Zero",
    description: "negative reviews with Tailor Studio",
  },
];
...
const filters = [
  ...
  { name: "Collaborations", category: "collaborations" },
