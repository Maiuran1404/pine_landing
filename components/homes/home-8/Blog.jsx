      ...
      <div className="row">
        <div className="col-8 col-sm-7">
          <h3 className="hs-title-5 font-alt overflow-hidden mb-100 mb-md-40">
            ...
            <span className="d-block text-end wow fadeRotateIn"> Collabs </span>
          </h3>
        </div>
      </div>
      {/* Blog Grid */}
      ...
      {/* <div className="row mt-100 mt-sm-60 wow fadeInUp">
        <div className="col-lg-8 offset-lg-2">
          <h2 className="section-title-tiny mb-30">
            <span className="icon-ellipse" /> Interested in collaborating?
          </h2>
          <form
              ...
              <div className="d-md-flex align-items-end">
                ...
                >
                  <span className="btn-animate-y">
                    <span className="btn-animate-y-1">Submit email</span>
