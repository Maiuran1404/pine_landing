    ...
    <div className="container min-height-100vh d-flex align-items-center pt-100 pb-100 pt-sm-120 pb-sm-120">
      ...
      <div className="home-content pb-sm-60 text-start position-relative">
        <h1 className="hs-title-5 font-alt overflow-hidden mb-30 mb-sm-20">
          <span className="d-block text-center wow fadeRotateIn">
            <Image
              ...
              data-wow-delay="0.8s"
              data-wow-offset={0}
              src="/assets/newphotos/Homepage_images/1.png"
              width={500}
              height={500}
              alt="Tailor Studio Homepage"
            />{" "}
            Tailor Studio
          </span>
          <span
          ...
          >
            ...
            <Image
              ...
              data-wow-delay="0.8s"
              data-wow-offset={0}
              src="/assets/newphotos/Homepage_images/2.png"
              alt="Tailor Studio Showcase"
              width={500}
              height={500}
        ...
        <h2
          ...
          data-wow-offset={0}
        >
          Specialized in Custom Apparel and Merchandise Design
        </h2>
        <p className="hs-paragraph-2 wow clipRightIn" data-wow-delay="0.8s">
          We are a full-service merchandise studio creating premium quality custom apparel and accessories. Our mission is to bring your brand vision to life through expert craftsmanship and attention to detail.
        </p>
